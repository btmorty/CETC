...
public partial class SelectClient : BasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if(!IsPostBack)
        {
            ...
            //Log User Activity
            base.LogActivity("Viewed Provider Report", true);
        }
    }
    //Redierect to cient page
    ...
    protected void ExportToExcel(object sender, EventArgs e)
    {
        ...
        Response.Charset = "";
        string FileName = "ProviderReport" + DateTime.Now + ".xls";
        ...
        Response.End();
        //Log User Activity
        base.LogActivity("Exported Provider Report", true);
    }
}