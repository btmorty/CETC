...
public static class GenericDataAccess
{
  ...
  // Instead of using Sql Server-specific objects directly (like SqlCommand and SqlConnection), this class uses
  // generic Db objects.  This way, if the underlying database changes (e.g. to Oracle), the only thing that needs
  // to be changed is the connection string in Web.Config!
